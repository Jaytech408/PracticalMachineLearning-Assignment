...
One thing that people regularly do is quantify how much of a particular activity they do, but they rarely quantify how well they do it. The goal of this project was to analyze data from accelerometers on the belt, forearm, arm, and dumbell of six participants in order to predict the manner in which they exercised. They were asked to perform barbell lifts correctly and incorrectly in five different ways. For more information see the “Weight Lifting Exercises Dataset” in the following location:

http://groupware.les.inf.puc-rio.br/har

The goal of this machine learning exercise is to predict the manner in which the participants did the exercise, which can is expressed by the “classe” variable found in the training set. The prediction model will then be used to predict twenty different test cases, as provided in the testing dataset.
...
wm <- read.csv("/Users/conniejin/Documents/Coursera/PracticalMachineLearning/pml-training.csv", header = TRUE, na.strings = c("NA", ""))
wm_test <- read.csv("/Users/conniejin/Documents/Coursera/PracticalMachineLearning/pml-testing.csv", header = TRUE, na.strings = c("NA", ""))
```
